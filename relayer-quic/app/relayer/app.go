...
import (
	...
	relayerquic "github.com/streamingfast/firehose-core/relayer-quic"
...
func (a *App) Run() error {
	...
	liveSourceFactory := bstream.SourceFactory(func(h bstream.Handler) bstream.Source {
		return relayerquic.NewMultiplexedSource(
			h,
	...
	a.relayer = relayerquic.NewRelayer(
		liveSourceFactory,
		a.config.QuicListenAddr,
		oneBlocksStore,
		zlog,
	)
